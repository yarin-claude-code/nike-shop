    ...
    <section id="about" className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Left - Promo Card */}
          <div className="relative bg-gradient-to-br from-primary-100 via-primary-50 to-white rounded-3xl p-8 overflow-hidden shadow-soft-md">
            <div className="relative z-10">
              <p className="text-primary-500 text-sm font-medium mb-2">Get up to</p>
              <p className="text-5xl md:text-6xl font-black text-accent mb-4">30% off</p>
              <p className="text-primary-400 text-sm">On selected premium footwear this season</p>
            </div>
            <img
              src={PROMO_SHOE_IMAGE}
              alt="Promo shoe"
              className="absolute bottom-0 right-0 w-48 h-48 object-contain opacity-40 translate-x-4 translate-y-4"
            />
          </div>
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-primary leading-tight tracking-tight">
              We Provide{' '}
              <span className="font-light text-primary-400">High Quality</span>{' '}
              Shoes.
            </h2>
            <p className="text-primary-500 leading-relaxed max-w-lg">
