    ...
    return (
      <div className="min-h-screen bg-surface flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-display-sm font-black text-primary mb-4">
            PRODUCT NOT FOUND
          </h1>
    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="bg-white border-b border-primary-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm">
            <Link to="/" className="text-primary-400 hover:text-primary transition-colors">
              Home
            </Link>
            <span className="text-primary-300">/</span>
            <Link to="/products" className="text-primary-400 hover:text-primary transition-colors">
              Products
            </Link>
            <span className="text-primary-300">/</span>
            <Link
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {relatedProducts.length > 0 && (
          <section className="mt-20 pt-12 border-t border-primary-200">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link
                to={`/products?category=${product.category.slug}`}
                className="hidden md:flex items-center gap-2 text-primary-400 hover:text-primary font-bold uppercase tracking-wider text-sm transition-colors"
              >
                View All
